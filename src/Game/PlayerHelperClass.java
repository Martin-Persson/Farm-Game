        ...
        for (Animal animal : player.getMyAnimals()) {
            if (animal.isSick()) {
                ...
                if(player.getMoney() < animal.getVetCost()){
                    System.out.println("Du har tyvärr inte råd att betala veterinärskostnaden.");
                    System.out.println(animal.getName() + " dog.");     //Denna if sats är ny
